...
function writecheck() {
	if( ! questionform.q_subject.value ) {
		alert( subjecterror );
		questionform.q_subject.focus();
		return false;
	} else if( ! questionform.q_content.value ) {
		alert( contenterror );
		questionform.q_content.focus();
		return false;
	} else if(! questionform.q_cate.value) {
		alert( cateerror );
		return false;
	}
