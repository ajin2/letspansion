...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
	...
	<c:set var="msg_input" value = "회원 정보를 입력하세요."/>
	...
	<c:set var="msg_zipcode" value = "읍/면/동 을 입력하세요."/>
	<c:set var="msg_modifyview" value = "수정할 정보를 입력하세요."/>
	<c:set var="msg_area3_x" value = "에 대한 우편번호가 없습니다.\n다시 검색해주세요."/>
	<c:set var="msg_find" value="아래의 정보를 입력해주세요."/>
	<c:set var="msg_re_passwd" value="변경할 비밀번호를 입력해주세요."/>
	...
	<c:set var="str_postcode" value = "우편번호"/>
	<c:set var="str_address" value = "주소"/>
	<c:set var="str_detail_add" value="상세주소"/>
	<c:set var="str_reg_date" value = "가입일자"/>
	<c:set var="str_email_confirm" value = "이메일 인증"/>
	<c:set var="str_delete" value="회원탈퇴"/>
         
	<c:set var="btn_login" value = "로그인"/>
	<c:set var="btn_login_cancel" value = "로그인 취소"/>
	...
	<c:set var="btn_postcode" value = "우편번호 검색"/>
	<c:set var="btn_search" value = "검색"/>
	<c:set var="btn_search_cancel" value = "검색취소"/>
	<c:set var="btn_mod" value = "수정"/>
	<c:set var="btn_mod_cancel" value = "수정취소"/>
	<c:set var="btn_email" value = "인증"/>
	<c:set var="btn_find" value="찾기"/>
	<c:set var="btn_find_cancel" value="찾기취소"/>