			...
			<c:forEach var="picture" items="${pictures}" varStatus="status">
				<div class="w3-third">
					<div class="w3-card w3-round"
						style="width: 80%; height: 300px; margin-left: 20%; margin: 5px;">
						<!-- class="w3-round" 사진 살짝 둥글게 -->
						<img src="${project}roomupload/${picture.pic_sys}" class="w3-round"
							style="width: 100%; height: 250px; cursor: pointer"
							onclick="location='pensionRoomDetail.do?r_id=${picture.r_id}'">
