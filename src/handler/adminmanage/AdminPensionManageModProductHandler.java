...
@Controller
public class AdminPensionManageModProductHandler implements CommandHandler{
	@RequestMapping("/adminManageModProduct")
	@Override
	public ModelAndView process(HttpServletRequest request, HttpServletResponse response) throws Throwable {
	    ...
	    String originName1 = multi.getOriginalFileName( "filemod" );
		String systemName1 = multi.getFilesystemName( "filemod" );
        ...
        return new ModelAndView("adminmanage/adminManageModProduct");
	}
}
